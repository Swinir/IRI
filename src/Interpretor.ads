...
package Interpretor is
   ...
   procedure Init(Path : in String; Intepreteur : out T_Interpretor);

   procedure Read_File_Content(Path : in String; Intepreteur : out T_Interpretor);
   ...
   procedure Increment_PC(Intepreteur : in out T_Interpretor);
   --    Pre => Get_PC(PC) >= 0,
   ...
   procedure Display_Infos(Intepreteur : in T_Interpretor);

   procedure Display_Single_Info(Intepreteur : in T_Interpretor);

   -- Interprétation d'une instruction
   --
   -- Cette procédure évalue et exécute une seule instruction.
    procedure Interpret_Single_Instruction(Intepreteur : in out T_Interpretor);
   ...
   procedure Interpret_All(Intepreteur : in out T_Interpretor);
